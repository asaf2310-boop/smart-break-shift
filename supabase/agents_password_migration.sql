-- ⚠️ מיושן (Phase 10) — אל תשתמשו בקובץ זה להתקנה חדשה.
-- השתמשו ב-agents_full_setup.sql + security_phase1_auth.sql.
-- קובץ זה נשמר לתאימות לאחור בלבד — לא יוצר password_plain או מדיניות פתוחות.
-- password_plain הוסר; אימות דרך Supabase Auth (security_phase1_auth.sql).
