...
export default function PaymentLinkGuestPdfPage() {
      ...
      <div className="space-y-6">
        ...
        <div className="rounded-2xl border border-primary/15 bg-primary/5 p-4 sm:p-5">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h2 className="text-sm font-bold text-on-surface mb-1">מה זה לינק לתשלום?</h2>
        ...
        <div>
          <h2 className="text-sm font-bold text-on-surface mb-3">
            תוכן המדריך ({paymentLinkFields.length} שדות + {paymentLinkTableFields.length} עמודות טבלה)
          </h2>
